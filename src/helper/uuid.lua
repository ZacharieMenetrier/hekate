...
function M.new(hwaddr)
  ...
  return INT2HEX(bytes[1])..INT2HEX(bytes[2])..INT2HEX(bytes[3])..INT2HEX(bytes[4]).."_"..
         INT2HEX(bytes[5])..INT2HEX(bytes[6]).."_"..
         INT2HEX(bytes[7])..INT2HEX(bytes[8]).."_"..
         INT2HEX(bytes[9])..INT2HEX(bytes[10]).."_"..
